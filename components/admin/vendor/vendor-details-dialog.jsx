...
export function VendorDetailsDialog({ 
  ...
  const openDocumentViewer = (imageUrl, documentType, title) => {
    setDocumentViewer({
      open: true,
      title,
      imageUrl,
  ...
  return (
    <>
      ...
      <Dialog open={documentViewer.open} onOpenChange={closeDocumentViewer}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
          <DialogHeader>
            <DialogTitle className="flex items-center justify-between">
              <span>{documentViewer.title}</span>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div className="flex-1 overflow-auto">
            {documentViewer.imageUrl && (
              <div className="flex justify-center">
                ...
                />
                <div className="hidden flex-col items-center justify-center p-8 text-muted-foreground">
                  ...
                  <Button
                    variant="outline"
                    className="mt-4"
                    onClick={() => window.open(documentViewer.imageUrl, '_blank')}
                  >
