...
export class PermissionManager {
  ...
  hasPermission(permission) {
    ...
    return role.permissions.includes(permission) || this.userPermissions.includes(permission);
  }
  ...
  getAllPermissions() {
    ...
    const role = ROLES[this.userRole.toUpperCase()];
    return role ? [...role.permissions, ...this.userPermissions] : this.userPermissions;
  }
